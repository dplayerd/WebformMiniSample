    ...
    <script>
        $(function () {
            $("#btnSave").click(function () {
                ...
                if (id) {
                    $.ajax({
                        url: "http://localhost:17133/Handlers/AccountingNoteHandler.ashx?ActionName=update",
                        type: "POST",
                        data: {
                            "ID": id,
                            "Caption": caption,
                    ...
                    $.ajax({
                        url: "http://localhost:17133/Handlers/AccountingNoteHandler.ashx?ActionName=create",
                        type: "POST",
                        data: {
                            "Caption": caption,
                            "Amount": amount,
